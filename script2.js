...
var incrementXbefore =++x;
var incrementXafter = x++;
var decrementXbefore = --x;
...
<p><span>x = ${x}  y = ${y}</span></p>
<p><span>sum of x + y = ${sum}</span</p>
<p><span>sub of x - y = ${sub}</span</p>
<p><span>mul of x * y = ${mul}</span</p>
<p><span>div of x / y = ${div}</span</p>
<p><span>modulo of x % y = ${modulo}</span</p>
<p><span>incrementoperatorbefore= ${incrementXbefore}</span></p>
<p><span>incrementoperatorafter = ${incrementXafter}</span></p>
<p><span>decrementoperator = ${decrementXbefore}</span></p>
